...
$emp_office_query="SELECT personcd AS PersonCode, officer_name AS OfficerName, off_desg AS Desg, gender AS Gender, mob_no AS Mobile,  bank_acc_no AS BankAccNo, poststat AS PostStat, CONCAT(office.officecd,' - ',office.office,', ',office.address1) AS office_details FROM personnel_counting INNER JOIN office ON personnel_counting.officecd = office.officecd ORDER BY personcd";
