...
//$photo=$_POST['Photo'];
$query_check_accno_exsist=mysql_query("SELECT bank_acc_no FROM personnel WHERE bank_acc_no='$BankAcNo'",$DBLink) or die(mysql_error());
...
$mxprsncd=mysql_query("SELECT max(MID(personcd,7,5)) as maxpersoncd from personnel where officecd like '$ofccd%'",$DBLink);
