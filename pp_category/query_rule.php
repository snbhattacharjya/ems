...
$rule_pp_result=mysql_query($rule_pp_query,$DBLink) or die(json_encode(array("Status"=>mysql_error())));
$rule_pp_result=mysql_fetch_assoc($rule_pp_result)or die(json_encode(array("Status"=>"Error in fetch Record Count")));
