...
function LoadEmployeebyOffice()
{
	...
	$.ajax({
	mimeType: 'text/html; charset=utf-8', // ! Need set mimeType only when run from local file
	url: 'pp_data_post_random/employee_by_office.php',
        type: "POST",
        data: {
            officecd: officecd
        },
...
function updatePersonalData(EmpCode, OfficerName, Desg, PostStat, Gender, dob, Status){
	...
	$.ajax({
		mimeType: 'text/html; charset=utf-8', // ! Need set mimeType only when run from local file
		url: 'pp_data_post_random/update_personal.php',
		type: 'POST',
		data: {
				EmpCode: EmpCode,
...
function updateAddressData(EmpCode, PresentAddr1, PresentAddr2, PermAddr1, PermAddr2, Status){
	...
	$.ajax({
		mimeType: 'text/html; charset=utf-8', // ! Need set mimeType only when run from local file
		url: 'pp_data_post_random/update_address.php',
		type: 'POST',
		data: {
				EmpCode: EmpCode,
...
function updateContactData(EmpCode, Email, Phone, Mobile, Status){
	...
	$.ajax({
		mimeType: 'text/html; charset=utf-8', // ! Need set mimeType only when run from local file
		url: 'pp_data_post_random/update_contact.php',
		type: 'POST',
		data: {
				EmpCode: EmpCode,
				Email: Email,
...
function updateSalaryData(EmpCode, Scale, BasicPay, GradePay, Status){
	...
	$.ajax({
		mimeType: 'text/html; charset=utf-8', // ! Need set mimeType only when run from local file
		url: 'pp_data_post_random/update_salary.php',
		type: 'POST',
		data: {
				EmpCode: EmpCode,
				Scale: Scale,
...
function updateBankData(EmpCode, BankCd, BranchName, BranchCd, BankAccNo, Status){
	...
	$.ajax({
		mimeType: 'text/html; charset=utf-8', // ! Need set mimeType only when run from local file
		url: 'pp_data_post_random/update_bank.php',
		type: 'POST',
		data: {
				EmpCode: EmpCode,
				BankCd: BankCd,
...
function updateEpicData(EmpCode, EpicNo, PartNo, SlNo, Status){
	...
	$.ajax({
		mimeType: 'text/html; charset=utf-8', // ! Need set mimeType only when run from local file
		url: 'pp_data_post_random/update_epic.php',
		type: 'POST',
		data: {
				EmpCode: EmpCode,
				EpicNo: EpicNo,
...
function updateAssemblyData(EmpCode, AssemblyTemp, AssemblyPerm, AssemblyOff, Status){
	...
	$.ajax({
		mimeType: 'text/html; charset=utf-8', // ! Need set mimeType only when run from local file
		url: 'pp_data_post_random/update_assembly.php',
		type: 'POST',
		data: {
				EmpCode: EmpCode,
...
function updateAdditionalData(EmpCode, Qualification, Language, Remarks, WorkingStatus, Status){
	...
	$.ajax({
		mimeType: 'text/html; charset=utf-8', // ! Need set mimeType only when run from local file
		url: 'pp_data_post_random/update_additional_data.php',
		type: 'POST',
		data: {
				EmpCode: EmpCode,
