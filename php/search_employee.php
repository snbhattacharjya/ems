...
function LoadEmployeebyOffice()
{
	...
	success: function(data) {
		...
		{
			table.row.add([retObj[i].PersonCode, retObj[i].OfficerName, retObj[i].Desg, '<a href="#" onclick="LoadPersonnelDetailsForm('+retObj[i].PersonCode+')"><span class="fa fa-pencil"></span>&nbsp;Edit</a>']).draw();
