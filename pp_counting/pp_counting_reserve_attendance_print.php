...
$counting_pp_query->bind_result($personcd,$officer_name,$off_desg,$officecd,$office_name,$address1,$address2,$poststatus,$mobile,$forassembly,$assemblyname,$groupid) or die($counting_pp_query->error);
