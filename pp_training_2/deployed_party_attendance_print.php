...
$deployed_party_query=$mysqli->prepare("SELECT personnel.personcd, personnel.officer_name, personnel.off_desg, office.officecd, office.office, office.address1, office.address2, poststat.poststatus, personnel.mob_no, personnel.forassembly, assembly.assemblyname, personnel.groupid FROM ((personnel INNER JOIN office ON personnel.officecd = office.officecd) INNER JOIN poststat ON personnel.poststat = poststat.post_stat) INNER JOIN assembly ON assembly.assemblycd = personnel.forassembly WHERE personnel.booked IN ('P') AND personnel.forassembly != '' AND personnel.groupid != 0 AND personnel.forassembly = ? ORDER BY personnel.groupid, poststat.poststat_order") or die($mysqli_countppds->error);
