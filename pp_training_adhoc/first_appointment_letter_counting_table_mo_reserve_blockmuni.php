...
<table width="100%" style="font-family: sans-serif; font-size: 11">
    <tr>
        ...
        <th width="60%">
            ...
            LETTER OF APPOINTMENT FOR COUNTING PERSONNEL<br>
            <?php //echo $env.", ".$dist;?>
    ...
    <tr>
        <th width="20%">Memo No: 216/PP CELL(Dist)/Elec </th>
      <th width="60%">&nbsp;

        </th>
        <th width="20%">Dated: 21/05/2019</th>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="3" style="padding-top: 15;">
            <table width="98%" border="1" align="center" cellpadding="5" cellspacing="0" style="font-family: sans-serif; font-size: 11">
                <tr>
                    <th width="15%">Counting Party No</th>
    ...
    <tr>
        <td colspan="3" style="padding-top: 10;">
            The Officer should report for Counting as per following schedule:
        </td>
    </tr>
    <tr>
        <td colspan="3" style="padding-top: 10;">
            <table width="98%" border="1" align="center" cellpadding="5" cellspacing="0" style="font-family: sans-serif; font-size: 11">
                <tr>
                    <?php
                        if ($pp_data[$i]['booked'] == 'P') {
                            ?>
                    <th width="25%">Assembly Constituency</th>
                    <?php
                        } ?>
                ...
                <?php
                        if ($pp_data[$i]['booked'] == 'P') {
                            ?>    
                    <td align="center"><?php echo $pp_data[$i]['assemblyname']; ?></td>
                    <?php
                        } ?>
    ...
    <tr>
        <th colspan="3" style="padding-top: 5; text-align: justify">
            DDO/Head of Office is directed to deliver immediately appointment letter to the Counting Supervisor/Assistant/Micro Observer after getting the signature of the incumbent on service return. He/She is further directed to ensure that all personnel under his institution/office shall report to the counting venue without fail and in time.
        </th>
    </tr>
    <tr>
        <th colspan="3" style="padding-top: 5; text-align: justify">
