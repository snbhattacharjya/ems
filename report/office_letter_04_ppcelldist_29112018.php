...
?>
    ...
    <tr>
		...
		<tr>
      <th width="50%" align="left">Memo No: 04/PPCELL(Dist)</th>
      <th width="50%" align="right">Dated: 29/11/2018 </th>
		</tr>
		<tr>
    ...
    <tr>
      ...
      <tr>
          ...
          <table border="1" cellspacing="0" cellpadding="5">
            ...
            <tr>
              <td>Sadar</td>
              <td>Rabindra Bhaban, Chinsurah</td>
              <td>06.12.2018. 11 a.m.</td>
            </tr>
            <tr>
              <td>Serampore</td>
              <td>Rabindra Bhaban, Serampore</td>
              <td>06.12.2018. 02 p.m.</td>
            </tr>
            <tr>
              <td>Chandannagar</td>
              <td>Rabindra Bhaban, Chandannagar</td>
              <td>07.12.2018. 11 a.m.</td>
            </tr>
            <tr>
              <td>Arambagh</td>
              <td>Rabindra Bhaban, Arambagh</td>
              <td>07.12.2018. 03 p.m.</td>
            </tr>
          </table>
        </td>
      </tr>
      ...
      <td width="50%" align="left">
          Received the copy with Memo No. 04/PPCELL(Dist)  dated. 29/11/2018
      </td>
