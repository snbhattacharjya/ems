	...
	<div class="col-sm-12">
    	<div class="box box-info">
        	<div class="box-header with-border">
            	<h3 class="box-title">ADD SDO FORM 
                <span id="show_subdiv">
                </span>
        		<?PHP 
...
<form class="form-horizontal" role="form" id="AddSdo_form" name="AddSdo_form">
         <div class="form-group" id="div_SelectUserType">
						...
						<div class="col-sm-5">
						<input type="text" disabled class="form-control" data-toggle="tooltip" data-placement="bottom" title="User Type" value="Sub Divisional Officer">
						</div>
  		</div>
