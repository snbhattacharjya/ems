...
?>
    ...
    <tr>
		...
		<tr>
      <th width="50%" align="left">Memo No: 12(95)/PPCELL(Dist)</th>
  ...
  &nbsp;&nbsp;&nbsp;Your written reply should reach the undersigned within 03 (three) days from the date of receipt of this letter. <br>
      ...
      <tr>
        <td colspan="2">
  			     <div align="left">Received the copy with Memo. No. 12(95)/PPCELL(Dist) Dated: 04/04/2018<br>
  ...
  <?php
   ...
   $opt = $_GET['opt'];
   $code = $_GET['code'];
   	$query_get_office=mysqli_query($DBLink,"SELECT office.officecd, office.office, office.officer_desg, office.address1, office.address2, block_muni.blockmuni, policestation.policestation, office.postoffice, office.pin, office.email, office.phone, office.mobile, office.tot_staff AS pp1_count, office.male_staff, office.female_staff, office.posted_date FROM (office INNER JOIN block_muni ON block_muni.blockminicd=office.blockormuni_cd) INNER JOIN policestation ON policestation.policestationcd=office.policestn_cd WHERE office.blockormuni_cd='$code' AND officecd NOT IN (SELECT DISTINCT officecd FROM personnel) ORDER BY office.officecd") or die(mysqli_error($DBLink));
   ...
   ?>
     ...
     &nbsp;&nbsp;&nbsp;Your written reply should reach the undersigned within 03 (three) days from the date of receipt of this letter. <br>
         ...
         <tr>
           <th colspan="2" align="right">
   		<br><img src="../img/dm_sign.jpg">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><br>
             District Panchayat Election Officer, &  <br>District Magistrate,<strong><u>Hooghly</u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
           </th>
         </tr>
         <tr>
           <td colspan="2" align="center">
         ...
         <tr>
           <td colspan="2">
     			     <div align="left">Received the copy with Memo. No.  12(95)/PPCELL(Dist) Dated: 04/04/2018<br>
     			     <strong>OFFICE CODE : <?php echo $res['officecd'];?></strong></div><br><br>
     			     <div align="right"> Signature of the receiving officer <br> with phone no. and office seal</div>
           </td>
         </tr>
   	</table>
