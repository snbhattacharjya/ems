...
<table width="100%" style="font-family: sans-serif; font-size: 11">
    <tr>
        ...
        <th width="60%">
            ...
            MODIFIED ORDER OF APPOINTMENT FOR POLLING DUTIES<br>
            <?php //echo $env.", ".$dist;?>
    ...
    <tr>
        <th width="20%">Memo No: 152/PP CELL(Dist)/Elec </th>
      <th width="60%">&nbsp;

        </th>
        <th width="20%">Dated: 23/04/2019</th>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="3" style="padding-top: 10;">
            This is cancellation of Order No. 145/PP CELL (Dist)/Elec dated 22/04/2019
        </td>
    </tr>
    <tr>
