...
?>
              <thead>
                <tr class="bg-teal-gradient">
                  ...
                  <th>PP2 Male Not Updated</th>
                  <th>PP2 Female Not Updated</th>
...
?>
                  <tr>
                    ...
                    <td><?php echo "<a href='report/office_pp2_showcause_letter_print.php?opt=blockmuni&code=".$subdiv_names[$i]['BlockMuniCode']."' target='_blank' class='text-red'><i class='fa fa-print'></i> print</a>"; ?></td>
                    <?php
