...
<table id="subdiv_booked_summary" class="table table-bordered table-condensed table-hover small">
	...
	<tr>
        ...
        ?>
            ...
            <td class="text-center"><a href="pp_training/form12_print_subdiv.php?subdiv_code=<?php echo $subdiv[$i]['SubdivCode']; ?>" class="text-red" target="_blank"><i class="fa fa-print"></i> Print</a></td>
        </tr>
        <?php
        }
        ?>
...
<script>
    $('.blockmuni-report-btn').click(function(e){
        ...
        loadBlockMuniForm12Summary(subdiv);
    });
