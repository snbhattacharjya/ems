...
<h3 class="page-header">
    New Personnel Summary Report
</h3>
<div class="text-center margin-bottom">
    <a class="btn btn-md btn-flat btn-default text-red" href="pp_data_post_random/subdiv_new_pp_summary_print.php" target="_blank"><i class="fa fa-print"></i> Print</a>
</div>
<table id="subdiv_exempt_summary" class="table table-bordered table-condensed table-hover small">
    ...
    <tbody>
        <?php
        $subdiv_exempt_query=$mysqli->prepare("SELECT subdivision.subdivisioncd, personnel_new.poststat, COUNT(personnel_new.personcd) FROM subdivision INNER JOIN personnel_new ON subdivision.subdivisioncd=personnel_new.subdivisioncd WHERE personnel_new.poststat != '' GROUP BY subdivision.subdivisioncd, personnel_new.poststat ORDER BY subdivision.subdivisioncd, personnel_new.poststat") or die($mysqli->error);
