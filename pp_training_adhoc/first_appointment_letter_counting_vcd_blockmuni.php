...
<table width="100%" style="font-family: sans-serif; font-size: 11">
    <tr>
        ...
        <th width="60%">
            ...
            LETTER OF APPOINTMENT FOR VVPAT COUNTING PERSONNEL<br>
            <?php //echo $env.", ".$dist;?>
    ...
    <tr>
        <td colspan="3" style="padding-top: 10;">
            The Officer should report for Counting VVPAT as per following schedule:
        </td>
    </tr>
    <tr>
        <td colspan="3" style="padding-top: 10;">
            <table width="98%" border="1" align="center" cellpadding="5" cellspacing="0" style="font-family: sans-serif; font-size: 11">
                ...
                <tr>
                    ...
                    <td align="center">23/05/2019 at 12:00 noon </td>
