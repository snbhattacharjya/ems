...
if($user_id != 'ADMIN'){
  ...
  $employee_exempt_query="SELECT office.officecd, office.office, personnel.personcd, personnel.officer_name, personnel.off_desg, personnel.mob_no, remarks.remarks, personnel_exempt_marked.reason FROM ((office INNER JOIN personnel ON office.officecd = personnel.officecd) INNER JOIN remarks ON personnel.remarks = remarks.remarks_cd) INNER JOIN personnel_exempt_marked ON personnel.personcd = personnel_exempt_marked.personcd ORDER BY office.officecd, personnel.officer_name";
