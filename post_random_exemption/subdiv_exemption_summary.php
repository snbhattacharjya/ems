...
<div class="text-center margin-bottom">
    <a class="btn btn-md btn-flat btn-default text-red" href="post_random_exemption/subdiv_exemption_summary_print.php" target="_blank"><i class="fa fa-print"></i> Print</a>
</div>
