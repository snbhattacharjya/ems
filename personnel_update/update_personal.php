...
$update_personal_query=$mysqli->prepare("UPDATE personnel SET officer_name = ?, off_desg = ?, gender = ?, dateofbirth = ?, posted_date = CURRENT_TIMESTAMP WHERE personcd = ?") or die(json_encode(array("Status"=>$mysqli->error)));
