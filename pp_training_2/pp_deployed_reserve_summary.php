...
<div class="text-center margin-bottom">
    <a class="btn btn-default btn-md" href="pp_training_2/pp_deployed_reserve_summary_print.php" target="_blank">
...
<table id="blockmuni_exempt_summary" class="table table-bordered table-condensed table-hover small">
	...
	<tr>
        ...
        <?php
            ...
            <td class="text-center"><a href="pp_training_2/second_appointment_letter.php?opt=ASSEMBLY_RESERVE&AssemblyCode=<?php echo $assembly_reserve[$i]['AssemblyCode']; ?>" class="text-red" target="_blank"><i class="fa fa-print"></i> Print</a></td>
            <td class="text-center"><a href="pp_training_2/deployed_reserve_attendance_print.php?AssemblyCode=<?php echo $assembly_reserve[$i]['AssemblyCode']; ?>" class="text-red" target="_blank"><i class="fa fa-print"></i> Print</a></td>
        </tr>
        <?php
    }
        ?>
    ...
    <tfoot>
        ...
        <tr class="danger">
            <th colspan="<?php echo count($poststat) + 5; ?>">
                <?php
