...
<h3 class="page-header">
    New Personnel Appointment Summary
</h3>
<?php
$posted_date_query=$mysqli->prepare("SELECT DISTINCT(DATE(posted_date)) FROM personnel_new ORDER BY DATE(posted_date) DESC") or die($mysqli->error);
