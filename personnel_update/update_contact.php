...
$update_contact_query=$mysqli->prepare("UPDATE personnel SET present_addr1 = ?, present_addr2 = ?, perm_addr1 = ?, perm_addr2 = ?, email = ?, resi_no = ?, mob_no = ? WHERE personcd = ?") or die(json_encode(array("Status"=>$mysqli->error)));
