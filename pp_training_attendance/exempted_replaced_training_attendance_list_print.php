...
$training_attendance_list_query=$mysqli->prepare("SELECT personnel_extra_replaced_494.personcd, personnel_extra_replaced_494.officer_name, personnel_extra_replaced_494.off_desg, office.officecd, office.office, office.address1, office.address2, poststat.poststatus, personnel_extra_replaced_494.mob_no, training_venue.venuename, training_schedule.training_dt, training_schedule.training_time FROM (((personnel_extra_replaced_494 INNER JOIN office ON personnel_extra_replaced_494.officecd = office.officecd) INNER JOIN poststat ON personnel_extra_replaced_494.poststat = poststat.post_stat) INNER JOIN training_schedule ON personnel_extra_replaced_494.training1_sch = training_schedule.schedule_code) INNER JOIN training_venue ON training_venue.venue_cd = training_schedule.training_venue ORDER BY training_venue.venuename") or die($mysqli->error);
...
<html>
    ...
    <thead>
        <tr>
            <th colspan="9">
                Attendance List for Exempted Replaced Personnel
            </th>
        </tr>
        <tr>
            <th>#</th>
