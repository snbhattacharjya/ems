...
$('.ajax_link').click(function (e) {
			...
			if(timer.PageTitle==null)
			{
				...
				//$('.sidebar-menu').closest('li').addClass('active');
			}
			else
			$('#PageTitle').html(timer.PageTitle);
			
			if(timer.PermitFlag==0)
			{
				$('#timer_div').hide();
				$('#page_content').empty();
				$('#page_content').hide();
			...
			else
			{
				...
				if(timer.TimerFlag==0||timer.TimerFlag==null){
					$('#timer_div').hide();
					$('#page_content').load(url);
					$('#page_content').show();
				}
				else if(timer.TimerFlag==1)
				{
					$('#start_time').html("Start Time: "+timer.StartTime);
					$('#end_time').html(", End Time: "+timer.EndTime);
					$('#page_content').load(url);
