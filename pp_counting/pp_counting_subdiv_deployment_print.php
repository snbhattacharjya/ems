<title>
    Counting PP Deployment by Subdivision
</title>
<?php
session_start();
...
?>
<h3>
    Counting Personnel Deployment By Subdivision
</h3>
<table border="1" cellpadding="5" cellspacing="0">
    <thead>
        <tr>
            <th>From Subdivision / Deployed Subdivision</th>
            <?php
    ...
    <tbody>
        <?php
        $pp_subdiv_deployment_query=$mysqli_countppds->prepare("SELECT personnela.subdivisioncd, personnela.forsubdivision, COUNT(personnela.personcd) FROM personnela WHERE personnela.booked IN ('P','R') GROUP BY personnela.subdivisioncd, personnela.forsubdivision ORDER BY personnela.subdivisioncd, personnela.forsubdivision") or die($mysqli_countppds->error);
