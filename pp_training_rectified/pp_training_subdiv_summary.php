...
<div class="text-center margin-bottom">
    <a class="btn btn-md btn-flat btn-default text-red" href="pp_training_rectified/pp_training_subdiv_summary_print.php" target="_blank"><i class="fa fa-print"></i> Print</a>
</div>
<table id="subdiv_booked_summary" class="table table-bordered table-condensed table-hover small">
	...
	<tr>
        ...
        ?>
            ...
            <td class="text-center"><a href="pp_training_rectified/first_appointment_letter_subdiv.php?subdiv_code=<?php echo $subdiv[$i]['SubdivCode']; ?>" class="text-red" target="_blank"><i class="fa fa-print"></i> Print</a></td>
        </tr>
        <?php
        }
        ?>
