...
<div class="row">
	<div class="col-md-12">
    	<div class="box box-info">
    		...
    		<h3 class="box-title">UPDATE EMPLOYEE 
       ...
       <div class="callout callout-info">	
		...
		<div id="add_image_form" hidden="">
       		...
       		<div class="alert bg-success">												
            	<H3><i class="fa fa-info"></i>&nbsp;&nbsp;Successfully Modified Employee&nbsp;
...
<button type="button" class="btn btn-success btn-lg"  id="confirm"><span><i class="fa fa-save"></i></span>&nbsp;&nbsp;Update Employee</button>
    	...
    	<button type="button" class="btn btn-app bg-maroon" id="skip"><span><i class="fa fa-forward"></i></span>&nbsp;&nbsp;Back</button>    
    </div>
	</div><!--BOX-->
	</div><!-- COLUMN-->
</div><!--ROW-->
...
$(this).prop( "disabled", true );
	var empcode=UpdateEmployee($('#confirm').val());
	$('#show_emp_cd').html("<b>"+$('#confirm').val()+"</b>");
	$('#personnel_form').hide();
	$('#confirm').hide();
	$('#add_image_form').show();
	$('#add_image').show();
...
$("#skip").click(function(e) {
	...
	$('#page_content').load('php/search_employee.php');
});
