...
$pp_office_query=$mysqli->prepare("SELECT personnel_rectified.personcd, personnel_rectified.officer_name, personnel_rectified.off_desg, personnel_rectified.mob_no, personnel_rectified.booked, personnel_rectified.poststat FROM personnel_rectified WHERE personnel_rectified.officecd = ?") or die($mysqli->error);
