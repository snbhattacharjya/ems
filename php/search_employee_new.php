...
function LoadEmployeebyOffice()
{
	...
	success: function(data) {
		...
		for(var i=0; i<employees.length; i++)
		{
			...
			var present_blockmuni_index=blockmuni.map(function(data) { return data.BlockMuniCode; }).indexOf(employees[i].PresentBlockMuni);
			var permanent_blockmuni_index=blockmuni.map(function(data) { return data.BlockMuniCode; }).indexOf(employees[i].PermanentBlockMuni);
			var posting_blockmuni_index=blockmuni.map(function(data) { return data.BlockMuniCode; }).indexOf(employees[i].PostingBlockMuni);
...
function updateData(DataTarget, Row){
	...
	if(DataTarget == 'blockmuni'){
		...
		var present_blockmuni_index=blockmuni.map(function(data) { return data.BlockMuniCode; }).indexOf(blockmuni_temp);
		var permanent_blockmuni_index=blockmuni.map(function(data) { return data.BlockMuniCode; }).indexOf(blockmuni_perm);
		var posting_blockmuni_index=blockmuni.map(function(data) { return data.BlockMuniCode; }).indexOf(blockmuni_off);
		...
		if(result == 'Success'){
			...
			//Adding Old Values
			var present_blockmuni_index=blockmuni.map(function(data) { return data.BlockMuniCode; }).indexOf(employees[RecordIndex].PresentBlockMuni);
			var permanent_blockmuni_index=blockmuni.map(function(data) { return data.BlockMuniCode; }).indexOf(employees[RecordIndex].PermanentBlockMuni);
			var posting_blockmuni_index=blockmuni.map(function(data) { return data.BlockMuniCode; }).indexOf(employees[RecordIndex].PostingBlockMuni);
