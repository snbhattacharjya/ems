...
$update_additional_query=$mysqli->prepare("UPDATE personnel SET qualificationcd = ?, languagecd = ?, remarks = ?, workingstatus = ?, posted_date = CURRENT_TIMESTAMP WHERE personcd = ?") or die(json_encode(array("Status"=>$mysqli->error)));
