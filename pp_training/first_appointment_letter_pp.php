<title>
    Personnel wise - 1st Appointment Letter
</title>
<?php
session_start();
...
$pp_data=array();
$first_app_query->fetch() or die($first_app_query->error);
    ...
    <tr>
        <td colspan="3" style="padding-top: 15;">
            <table width="98%" border="1" align="center" cellpadding="5" cellspacing="0" style="font-family: sans-serif; font-size: 11">
                ...
                <tr>
                    <th align="left"><?php echo $pp_data['officer_name']."<br>".$pp_data['off_desg']."<br>PIN - ".$pp_data['personcd']; ?></th>
                    <td align="left"><strong><?php echo $pp_data['office']." (".$pp_data['officecd']."), </strong>".$pp_data['address']." P.O. - ".$pp_data['postoffice'].", Subdiv - ".$pp_data['subdivision'].", P.S. - ".$pp_data['policestation'].", Dist - ".$pp_data['district'].", Pincode - ".$pp_data['pin']; ?></td>
                    <th align="center"><?php echo $pp_data['poststatus']; ?></th>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <td colspan="3" style="padding-top: 10;">
            <table width="98%" border="1" align="center" cellpadding="5" cellspacing="0" style="font-family: sans-serif; font-size: 11">
                ...
                <tr>
                    <th align="center"><?php echo $pp_data['training_desc']; ?></th>
                    <th align="left"><?php echo $pp_data['venuename'].", ".$pp_data['venueaddress']; ?></th>
                    <th align="center"><?php echo date_format(date_create_from_format("Y-m-d H:i:s",$pp_data['training_dt']),"d/m/Y").", ".$pp_data['training_time']; ?></th>
                </tr>
            </table>
        </td>
    </tr>
            ...
            <table width="100%" style="font-family: sans-serif; font-size: 11">
                <tr>
                    ...
                    <td width="33%" align="center">
                        ...
                        <strong><?php echo $pp_data['block_muni_name']; ?></strong>
                    </td>
                    <td width="33%">
