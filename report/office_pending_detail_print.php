...
<h3 class="box-title">Office Pending Report (LOW Personnel)</h3>
<table border="1" cellspacing="0" cellpadding="5">
<thead>
<tr class="warning">
  <th>Office Code </th>
...
<?php
  ...
  $total_male+=$res['male_staff'];
	$total_female+=$res['female_staff'];
  $total_pp2+=$res['pp2_count'];
  $total_pp2_update+=$res['pp2_update_count'];
...
<td><?php echo $res['pp2_update_count']; ?></td>
</tr>
<?php
	}
?>
...
<tr class="info">
	<th colspan="3">Total Office</th>
    <th><?php echo $count;?></th>
    <th colspan="2">Total PP1 Count</th>
    <th><?php echo $total_pp1;?></th>
    <th><?php echo $total_male;?></th>
    <th><?php echo $total_female;?></th>
    <th>Total PP2 Count</th>
    <th><?php echo $total_pp2;?></th>
    <th><?php echo $total_pp2_update;?></th>
</tr>
</tfoot>
</table>
