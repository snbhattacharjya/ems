...
<table width="100%" style="font-family: sans-serif; font-size: 11">
    ...
    <tr>
        <th width="20%">Memo No: 68/PP CELL(Dist)/Elec </th>
      <th width="60%">&nbsp;
    ...
    <tr>
        <td colspan="3" style="padding-top: 10;">
            The Officer should report for Training as per following modified schedule [Ref: ORDER OF APPOINTMENT FOR TRAINING, GENERAL ELECTION TO THE HOUSE OF PEOPLE, 2019 vide order no 61/PP Cell(Dist)/Elec dated - 13/03/2019]:
        </td>
    </tr>
    <tr>
        <td colspan="3" style="padding-top: 10;">
