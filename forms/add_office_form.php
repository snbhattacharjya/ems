...
<div class="form-group" id="div_TotalMaleStaffs">
						...
						<div class="col-sm-5">
							   <input type="text" class="form-control check-number emp" placeholder="Total Male Staff" name="TotalMaleStaff" id="TotalMaleStaffs" data-toggle="tooltip" data-placement="bottom" title="Enter Total Male Staff" maxlength="5">
                        </div>
</div>
<div class="form-group" id="div_TotalFemaleStaffs">
						<label class="col-sm-4 control-label">Total Female Staff</label>
						<div class="col-sm-5">
							   <input type="text" class="form-control check-number emp" placeholder="Total Female Staff" name="TotalFemaleStaff" id="TotalFemaleStaffs" data-toggle="tooltip" data-placement="bottom" title="Enter Fax No" maxlength="5">
                        </div>
</div>
<div class="form-group" id="div_TotalNumberofStaffs">
						<label class="col-sm-4 control-label">Total Number of Staff</label>
						<div class="col-sm-5">
							   <input type="text" class="form-control check-total" placeholder="Total Number of Staff" name="TotalNumberofStaff" id="TotalNumberofStaffs" data-toggle="tooltip" data-placement="bottom" title="Enter Total Number of Staff" maxlength="6" readonly="readonly">
      					</div>
</div>
</div>
