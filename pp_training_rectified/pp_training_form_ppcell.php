        ...
        <div class="box-body">          
            <div class="box-header">
                <a class="btn btn-app training-summary">
                    <i class="fa fa-globe icon"></i> Training Appointment Rectification Summary
                </a>
...
<script>
$(function(){
    //$.getScript("pp_training_rectified/pp_training_func.js");
});
...
function loadSubdivPPExtraBookedSummary(){
    ...
    $.ajax({
            mimeType: 'text/html; charset=utf-8', // ! Need set mimeType only when run from local file
            url: "pp_training_rectified/pp_form12_subdiv_summary.php",
            //type: "POST",
            //data: {
                //target_url: data_target
            //},
