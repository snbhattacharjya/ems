...
if($status == 'OLD'){
    ...
    $update_ppds_personnel_query->bind_param("ssssssss",$present_addr1,$present_addr2,$perm_addr1,$perm_addr2,$email,$phone,$mobile,$emp_code) or die(json_encode(array("Status"=>$update_ppds_personnel_query->error)));
    ...
    $update_ppds_personnela_query->bind_param("ssssssss",$present_addr1,$present_addr2,$perm_addr1,$perm_addr2,$email,$phone,$mobile,$emp_code) or die(json_encode(array("Status"=>$update_ppds_personnela_query->error)));
