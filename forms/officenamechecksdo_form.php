...
<div class="col-xs-12 col-sm-10">
    ...
    <div>        
       <form class="form-horizontal" role="form">
    <button type="button" class="btn btn-primary btn-lg btn-label-left" id="next"><span><i class="fa fa-save"></i></span>Next</button></form>
  </div>
</div>
<script>
var officecd;
...
officecd=$("#OfficeName").val();
 $.ajax({
		...
		success: function(data) {
			...
			LoadOfficeDetailsSDOForm(officecd);	
		},
		error: function (jqXHR, textStatus, errorThrown) {
			alert("Secure insert Error");
		},
