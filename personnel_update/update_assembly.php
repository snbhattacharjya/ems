...
$update_assembly_query=$mysqli->prepare("UPDATE personnel SET assembly_temp = ?, assembly_perm = ?, assembly_off = ? WHERE personcd = ?") or die(json_encode(array("Status"=>$mysqli->error)));
