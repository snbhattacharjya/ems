...
<table id="schedule_table" class="table table-bordered table-condensed small">
    <thead>
        <tr>
            ...
            <th class="text-center bg-maroon" colspan="4">Date: <span class="training_date"><?php echo $training_date; ?></span>, Time: <span class="training_time"><?php echo $training_time; ?></span></th>
        </tr>
        <tr>
