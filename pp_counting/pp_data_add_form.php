...
?>
  ...
  <h3 class="page-header">New Counting Personnel Details for Office Code: <span class="officecd"><?php echo $officecd; ?></span></h3>
  ...
  <form class="form-horizontal" role="form" id="personnel_add_form">
    <div class="row">
      <div class="col-sm-6">
        ...
        <div class="form-group col-sm-12" id="div_Group">
          <label class="control-label">Employee Group</label>
          <div>
            <select name="Group" id="Group" class="form-control select2" data-toggle="tooltip" data-placement="bottom" title="Enter Employee Group">
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="callout bg-info" style="margin-bottom: 0!important;">
          <i class="fa fa-info"></i>&nbsp;&nbsp;&nbsp;Block/ Municipality Details
        </div>
        <div class="form-group col-sm-12" id="div_BlockMuni_temp">
          <label class="control-label"><font color="red">*</font>Block/Municipality for Present/Temporary Address</label>
          <div>
            <select name="BlockMuni_temp" id="BlockMuni_temp" class="form-control select2" data-toggle="tooltip" data-placement="bottom" title="Enter Present Block/Municipality Name">
              <option value="">Select Block/Municipality</option>
            </select>
          </div>
        </div>

        <div class="form-group col-sm-12" id="div_BlockMuni_perm">
          <label class="control-label"><font color="red">*</font>Block/Municipality for Permanent Address/Voter BlockMuni</label>
          <div>
            <select name="BlockMuni_perm" id="BlockMuni_perm" class="form-control select2" data-toggle="tooltip" data-placement="bottom" title="Enter PermananentBlock/Municipalityi Name">
              <option value="">Select Block/Municipality</option>
            </select>
          </div>
        </div>

        <div class="form-group col-sm-12" id="div_BlockMuni_off">
          <label class="control-label"><font color="red">*</font>Block/Municipality for Place of Posting/Office</label>
          <div>
            <select name="BlockMuni_off" id="BlockMuni_off" class="form-control select2" data-toggle="tooltip" data-placement="bottom" title="Enter Voter Of Block/Municipality">
              <option value="">Select Block/Municipality</option>
            </select>
          </div>
        </div>
  ...
  <script type="text/javascript">
    ...
    function loadBlockMuniDetails(){
        ...
        for(var i=0; i<blockmuni.length; i++){
                $('#BlockMuni_temp').append("<option value='"+blockmuni[i].BlockMuniCode+"'>"+blockmuni[i].BlockMuniCode+' - '+blockmuni[i].BlockMuniName+"</option>");
                $('#BlockMuni_perm').append("<option value='"+blockmuni[i].BlockMuniCode+"'>"+blockmuni[i].BlockMuniCode+' - '+blockmuni[i].BlockMuniName+"</option>");
                $('#BlockMuni_off').append("<option value='"+blockmuni[i].BlockMuniCode+"'>"+blockmuni[i].BlockMuniCode+' - '+blockmuni[i].BlockMuniName+"</option>");
        }
        //assembly_combo+="</select>";
        $('#BlockMuni_temp').select2();
        $('#BlockMuni_perm').select2();
        $('#BlockMuni_off').select2();
    }
    ...
    function AddEmployee() {
      ...
      $.ajax({
        url: 'pp_counting/pp_data_add.php',
        type: 'POST',
        data: {
        ...
        error: function(jqXHR, textStatus, errorThrown) {
          $('#report_panel').removeClass('panel-warning').removeClass('panel-success').addClass('panel-danger').show();
          $('#report_result').html("Error in Data Fields. Please Check!!!"+errorThrown);
          $('#report_result').append("<span class='pull-right'><a href='#' class='show-form'><i class='fa fa-binoculars'></i> Show Form | </a><a href='#' class='new-form'><i class='fa fa-plus-square'></i> Add New PP</a></span>");
        },
        dataType: "json",
        async: false
