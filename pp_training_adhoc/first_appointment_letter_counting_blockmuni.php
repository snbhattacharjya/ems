...
<table width="100%" style="font-family: sans-serif; font-size: 11">
    <tr>
        ...
        <th width="60%">
            ...
            LETTER OF INTIMATION FOR TRAINING OF COUNTING PERSONNEL<br>
            <?php //echo $env.", ".$dist;?>
    ...
    <tr>
        <td colspan="3" style="padding-top: 15; text-align: justify">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; In exercise of the power conferred upon me vide section 26 of the R. P. Act, 1951, I do hereby initmate you for undergoing training in connection with the GENERAL ELECTION TO THE HOUSE OF PEOPLE, 2019 for <strong><?php echo $pp_data[$i]['pcname']; ?> PC</strong>.
    </tr>
    <tr>
