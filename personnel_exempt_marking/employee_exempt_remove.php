...
$employee_exempt_remove_query=$mysqli->prepare("DELETE FROM personnel_exempt_marked WHERE personcd = ? AND UserID = ?") or die(json_encode(array("Status"=>$mysqli->error)));
