...
<table id="pp_office_report" class="table table-bordered table-condensed table-hover small">
	...
	<tr>
            ...
            ?>
            <td class="text-center"><a href="pp_training_extra/first_appt_letter_pp_extra.php?person_code=<?php echo $pp_office[$i]['personcd']; ?>" class="text-red" target="_blank"><i class="fa fa-print"></i> Print</a></td>
            <?php
            }
            else{
                echo "<td>&nbsp;</td>";
